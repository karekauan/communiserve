...
export default function RegisterWorkerScreen({ navigation }) {
  ...
  const loadSkills = async () => {
    try {
      ...
      Alert.alert('Erro', 'Erro ao carregar habilidades. Tente novamente.');
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const response = await usersService.createWorker(userData, formData.password, selectedSkills);
      ...
      const errorMessage = error.response?.data?.errors 
        ...
        : 'Erro ao cadastrar trabalhador. Tente novamente.';
  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Registrar Trabalhador</Text>
        ...
        <View style={styles.content}>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.buttonText}>Cadastrar Trabalhador</Text>
            )}
          </TouchableOpacity>
        </View>
      </ScrollView>
